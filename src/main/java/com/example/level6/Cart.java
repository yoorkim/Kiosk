...
public class Cart {
    ...
    // total 의 자료형 변경 메서드
    public static BigDecimal setTotal(double total) {
        // BigDecimal 생성 후 반올림
    ...
    // 장바구니에 메뉴 추가하는 메서드
    public static void addCartItems(MenuItem menuItem) {
    ...
    // 장바구니 내용 출력하는 메서드
    public static void printCartItems(double total) {
        System.out.println("\n[ Orders ]");
    ...
    public static void removeCartItemByName(String menuName) {
    ...
    public static void dropItemsOverLimit(double max) {
    ...
    public static boolean isMenuInCart(String menuName) {
